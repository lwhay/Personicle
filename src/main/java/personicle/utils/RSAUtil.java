...
public class RSAUtil {
    private static final String DEFAULT_PUBLIC_KEY_PATH = "./resources/db/public.key";

    private static final String DEFAULT_PRIVATE_KEY_PATH = "./resources/db/private.key";
     ...
     * @throws Exception
     */
    public static void generateKeyToFile(String algorithm, String pubPath, String priPath, long seed) throws Exception {
        // 获取密钥对生成器
     ...
     * @throws Exception
     */
    public static void decodeByte(int maxSize, Cipher cipher, byte[] data, int total, ByteArrayOutputStream baos)
            throws Exception {
        // 偏移量
        int offset = 0;
        // 缓冲区
    ...
    public static void main(String[] args) throws Exception {
        generateKeyToFile("RSA", DEFAULT_PUBLIC_KEY_PATH, DEFAULT_PRIVATE_KEY_PATH, System.currentTimeMillis());
        PublicKey pk = loadPublicKeyFromFile("RSA", DEFAULT_PUBLIC_KEY_PATH);
        PrivateKey vk = loadPrivateKeyFromFile("RSA", DEFAULT_PRIVATE_KEY_PATH);
        System.out.println(pk.getEncoded());
        String origin = "I have nothing, nothing, a song of Witney Houston\n";
        System.out.print(origin);
        String coding = encrypt("RSA", origin, vk, 1024);
        System.out.println(coding);
        String decode = decrypt("RSA", coding, pk, 1024);
