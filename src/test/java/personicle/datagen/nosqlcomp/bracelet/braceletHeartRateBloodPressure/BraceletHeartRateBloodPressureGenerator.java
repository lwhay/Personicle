...
public class BraceletHeartRateBloodPressureGenerator {
    ...
    public static void Generator(int mc, List<UUID> AttriSet, List<String> userList, Map<String, List<String>> userMap)
        ...
        BufferedWriter bw1 = new BufferedWriter(new FileWriter("./example/BigBraceletHeartRateBloodPressure.adm"));
        BufferedWriter bw2 = new BufferedWriter(new FileWriter("./example/BraceletHeartRateBloodPressure_alone.adm"));
        BufferedWriter bw3 = new BufferedWriter(new FileWriter("./example/BraceletHeartRateBloodPressure_general.adm"));
        for (UUID device : deviceSet) {
            ...
            for (int i = 0; i < gran; i++) {
                BraceletHeartRateBloodPressure BigLog = new BraceletHeartRateBloodPressure();
                // general
                ...
                BraceletHeartRateBloodPressureAlone alone = new BraceletHeartRateBloodPressureAlone(BigLog);
